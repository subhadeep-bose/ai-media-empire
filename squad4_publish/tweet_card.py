...
Tweet card renderer — two layouts:
  ...
  render_body_card()  — not used (tweets 2-6 post as plain text for readability)
...
def render_hot_take_card(tweet_text: str) -> bytes:
    ...
    """
    W, H = TWEET_CARD_WIDTH, TWEET_CARD_HEIGHT
    bg = (18, 10, 10)          # very dark red-black
    accent = (255, 80, 80)     # hot red
    white = _hex_to_rgb(BRAND_TEXT_COLOR)
    muted = (120, 100, 100)
